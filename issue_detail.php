...
<div class="container" id="mainContainer">
  ...
  <div id="issueContent">
    ...
    <?php else: ?>
      <script>
        const staticIssues = [
          { title: "Large pothole on Main Street", category: "Roads", description: "There is a large pothole...", image: "pathole.jpg", reporter: "John Doe", date: "2025-05-15" },
          { title: "Overflowing garbage bin", category: "Sanitation", description: "Garbage bins near park...", image: "garbage.jpg", reporter: "Jane Smith", date: "2025-06-02" }
        ];
